...
class HSumGraph(nn.Module):
    ...
    def __init__(self, hps, embed,vocab2):
        ...
        self.model1 = PointerGeneratorNetworks(vob_size=50000,embed_dim=64,hidden_dim=128,pad_idx = vocab2.pad_idx,dropout=0.5,pointer_gen = True,use_coverage=True,_embed=self._embed)
        #self.model1 = PointerGeneratorNetworks(vob_size=50000,embed_dim=128,hidden_dim=256,pad_idx = vocab2.pad_idx,dropout=0.5,pointer_gen = True,use_coverage=True,_embed=self._embed)
        # word -> sent
