...
class sentEncoder(nn.Module):
    ...
    def forward(self, input):
        ...
        #enc_conv_input1=self.simAM(enc_conv_input)
        ...
        '''enc_conv_output1 = [F.relu(conv(enc_conv_input1).squeeze(3)) for conv in self.convs]  # kernel_sizes * [s_nodes, Co=50, W]
        enc_maxpool_output1 = [F.max_pool1d(x, x.size(2)).squeeze(2) for x in enc_conv_output1]  # kernel_sizes * [s_nodes, Co=50]
        sent_embedding1 = torch.cat(enc_maxpool_output1, 1)  # [s_nodes, 50 * 6]     '''   
